        ...
        <div class="content">
          <div v-show="tab === 1" class="contentItem">
            <div class="wrap">
              <p>
                <span>SKILLS</span>
                そのため最初は、時間効率、技術の順序等も悪く、2022年6月頃から技術が伸び始めた気がしていて、更に2023年1月からもっと伸びていると思います。<br>
                レスポンシブデザインの対応可能です。<br>
                初めてのことに関しては、書いてあるものを、実装しようとしているものを、調べながら読み解く流れです。<br>
                基本的には調べて多少時間はかかったとしても完成はできます。<br>
                ※最悪妥協して非効率なやり方でも完成させます。<br>
                CMSに関しては大規模サイトは経験がないですが、WordPressを0からオリジナルテーマの作成ができます。GMO MAKE SHOP、Shopifyの作成経験があり、ECの概要は理解しています。
              </p>
            </div>
            <ul class="list">
          ...
          <div v-show="tab === 2" class="contentItem">
            <div class="wrap">
              <p>
                <span>OTHER</span>
                デザインについては、UI,UXの基本は抑えています。<br>
                UIは、コリス、流行り、などの確認はしていて、少しずつ向上はしています。デザインツールは基本XDを使用しており、Photoshop、Illustratorも基本操作は可能です。<br>
                パッケージ管理は、gulp、yarnは使用しておらず、npm scriptsです。<br>
                サーバー等の知識は、Web制作に必要なものは抑えており、サイト移転、サーバー移転、ga4なども可能です。<br>
                SEO、アクセシビリティ、などやらなければいけないことがたくさんありますが、いつか習得する予定です。
              </p>
            </div>
          </div>
        </div>
      ...
      self: [
        {
          boxClass: "innerTop",
          title: "略歴",
          desc: "2021年4月からWEB業界へ。"
        },
        {
          boxClass: "innerBottom",
          title: "趣味",
          desc: "スノーボード、散歩、漫画、昔はアニメ鑑賞でしたが、現在は仕事の影響か、アニメの映像に注目するようになりました。"
        }
      ],
      // スキル
      skill: [
        ...
        },
        {
          ...
          level: "5",
          num: "3",
          desc: '独学なので、自分の評価が難しいですが、中級レベルくらいと思っています。これからもどんどん突き詰めます。開発などフルスクラッチでの経験はありません。SPAサイトが自分のできる限りのことを書いています。使用する場面では、あえて新しい方法での、実装を心がけています。自分のサイトで、少し開発的なことを実装してみようと思います。'
        },
        {
          icon: "../icon-php.svg",
          title: "PHP",
          level: "4",
          num: "4",
          desc: "基本の形は抑えていますが、経験業務はWordPressと修正案件での自作フォーム(smartyを使用)です。ほとんどWordpressがメインです。自身のSPAサイトで素のPHPでフォームを作成し、データベースと接続をしました。"
        },
        {
        ...
        },
        {
          ...
          level: "0",
          num: "6",
          desc: "まだ勉強しておらず、優先順位的にもう少しスキルアップした後に勉強開始予定です。"
        },
        {
          icon: "../icon-wp.svg",
          title: "WordPress",
          level: "7",
          num: "7",
          desc: "テンプレート階層を理解して、オリジナルテーマを作成でき、サーバー移転、function.phpの記述ができます。1回だけTCDのテーマから制作がありましたが、オリジナルテーマのほうがやりやすいです。機能少なめなECサイトの制作は業務で経験しました。プラグインは作り方は知っていますが、自分で作成して使用はしたことはありません。"
        },
        {
          icon: "../icon-vue.svg",
          title: "Vue.js",
          level: "3",
          num: "8",
          desc: "このサイトで初めて触りました。htmlに似ているのでやはり使いやすい印象で、今後も使用していこうと考えましたが、一旦Reactかなと考え始めています。業務でも時間があったときに一度だけ導入したことがあります。"
        },
        {
          icon: "../icon-nuxt.svg",
          title: "Nuxt.js",
        ...
        },
        {
          ...
          level: "1",
          num: "10",
          desc: "ステップアップのために一旦触っていこうと思い、導入から、props、jsxなどの基本は抑えました。vueとどっちを先にvanilla jsと平行していくか、まだ悩んでいますが、少しReact優勢です。"
        },
        {
          icon: "../icon-node.svg",
          title: "Node.js",
          level: "1",
          num: "11",
          desc: "色々調べているうちに、JavaScriptをやるならnode.jsも触っていかないといけないかなと。優先順位的にはtsくらいで、少し低めではありますが、いつの日か習得します。今はexpressかなとぼんやり考えています。"
        },
        {
          icon: "../icon-git.svg",
          title: "git",
          level: "3",
          num: "12",
          desc: "githubで個人で管理していて、add,commit,pushなど基本操作は理解しています。"
        },
        {
          icon: "../icon-mysql.svg",
          title: "MySql",
          level: "3",
          num: "13",
          desc: "自身で作成している、SPAサイトでフォームから送信されたデータを接続、格納までは可能です。phpmyadminを利用しており、基本構文の意味などは理解しています。"
        },
        {
          icon: "../icon-pc.svg",
          title: "その他",
          level: "10",
          num: "14",
          desc: "基本の制作環境は、npmでsass、post cssのみです。webpack、EsLint、Pritter、gulp、babel、自分の環境での使用経験はあります。Turbopackを検討中"
        },
      ],
    }
  },
