<template>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <nav class="footerSns" target="_blank" rel="noopenner">
        <!-- <a href="">
        ...
        <a href="https://zenn.dev/yuyuyusan" target="_blank" rel="noopenner noreferrer" class="">
        ...
        <a href="https://github.com/yuyuyusan/" target="_blank" rel="noopenner noreferrer">
    ...
    <p class="copy">&copy;2022 Yushi Shitsukawa inc.</p>
  </footer>
</template>
