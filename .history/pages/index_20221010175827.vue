...
.topMv .photoScroll .photoWrap .photo .photoItem {
  ...
  &:nth-child(3n + 1):after {
    animation: imgHidden 7s cubic-bezier(.36, .78, .23, .99) forwards;
  }

  &:nth-child(3n + 2):after {
    animation: imgHidden 8s cubic-bezier(.36, .78, .23, .99) forwards;
  }

  &:nth-child(3n + 3):after {
    animation: imgHidden 8.5s cubic-bezier(.36, .78, .23, .99) forwards;
  }
