        ...
        <div class="content">
          <div v-show="tab === 1" class="contentItem">
            <div class="wrap">
              <p>
                <span>SKILLS</span>
                現在、経験年数1年6ヶ月です。レスポンシブデザインはPCのデザインが基本上がってきて、自分で考えて作成しているので対応できます。<br>
                初めてのことに関しては、書いてあるものを、実装しようとしているものを、調べながら読み解く流れです。<br>
                基本的には調べて多少時間はかかったとしても完成はできます。<br>
                ※最悪妥協して非効率なやり方でも完成させます。<br>
                CMSに関しては大規模サイトは経験がないですが、WordPressを0からオリジナルテーマの作成ができます。GMO MAKE SHOPを使用し、制作経験有。
              </p>
            </div>
            <ul class="list">
          ...
          <div v-show="tab === 2" class="contentItem">
            <div class="wrap">
              <p>
                <span>OTHER</span>
                デザインについては、UIは少々苦手ですがUX、マイクロインタラクションはデザイナー、ディレクターにも意見などしていて(UX優先の考え方のため)、UI,UXの基本は抑えています。<br>
                UIは、collis、流行り、マテリアルデザインなどの確認はしていて、少しずつ向上はしています。デザインツールは基本XDを使用しており、Photoshop、Illustratorも基本動作は可能です。<br>
                パッケージ管理は、gulp、yarnは使用しておらず、npm scriptsです。<br>
                サーバー等の知識は、色々ありすぎて、初歩的なことなのかどうかもわかっていない状態ですが、Web制作に必要なものは抑えており、サイト移転、サーバー移転、ga4なども可能です。<br>
                今後は、Vue,Nuxtを勉強しつつ、React、データベースについて、いつの日かアプリも作ってみたいのでReact Nativeを勉強しようと考えています。
              </p>
            </div>
          </div>
        </div>
    ...
    return {
      ...
      skill: [
        ...
        },
        {
          ...
          level: "1",
          num: "11",
          desc: "WordPressの構造だけ少し知っている状態から、少し知識を増やした程度です。今後sql言語も勉強していきたいです。"
        },
        {
          icon: "../icon-pc.svg",
          title: "その他",
