    ...
    return {
      ...
      skill: [
        ...
        },
        {
          ...
          level: "5",
          num: "3",
          desc: "JavaScriptの基本の形は抑えていますが、開発などフルスクラッチでの経験はありません。<br>案件で使用する場面では、あえて新しい事実装で再現を心がけています。非同期通信なども、業務では使用しないですが、JSONファイルとの連携などは実装可能です。現在webGL、beforeRouteLeave（ナビゲーションゲート）を次は学ぼうと考えています。"
        },
        {
          icon: "../icon-php.svg",
          title: "PHP",
