        ...
        <div class="content">
          ...
          <div v-show="tab === 2" class="contentItem">
            <div class="wrap">
              <p>
                <span>OTHER</span>
                デザインについては、UIは少々苦手ですがUX、マイクロインタラクションはデザイナー、ディレクターにも意見などしていて、デザイン用語、デザインツール、UXの基本は抑えています。<br>
    ...
    return {
      ...
      skill: [
        ...
        },
        {
          ...
          level: "5",
          num: "3",
          desc: "JavaScriptの基本の形は抑えていますが、開発などフルスクラッチでの経験はありません。<br>案件で使用する場面では、あえて新しい事実装で再現を心がけています。非同期通信なども、業務では使用しないのですが、JSONファイルとの連携などは実装可能です。cssと同じくモダンな技術を可能な限り取り入れています。(IntersectionObserverなど)<br>現在webGL、beforeRouteLeave（ナビゲーションゲート）を次は学ぼうと考えています。"
        },
        {
          icon: "../icon-php.svg",
          title: "PHP",
