    ...
    return {
      ...
      skill: [
        ...
        },
        {
          ...
          level: "6",
          num: "3",
          desc: 'JavaScriptの基本の形は抑えていますが、開発などフルスクラッチでの経験はありません。SPAサイトが自分のできる限りのことを書いています。案件で使用する場面では、あえて新しい方法での、実装を心がけています。cssと同じくモダンな技術を可能な限り取り入れています。今後はapi利用して、少し開発的なことを自身のもう一つのサイトで実装してみようと思います。'
        },
        {
          icon: "../icon-php.svg",
          title: "PHP",
        ...
        },
        {
          ...
          level: "6",
          num: "5",
          desc: "初めての学習がjQueryでした。ただ業務を重ねていくうちに脱jQueryしようと思い始め基本的には使わない方向性で制作に取り組んでいます。アコーディオンはjQueryの方が実装が楽なので使用しています。"
        },
        {
          icon: "../icon-ts.svg",
          title: "TypeScript",
          level: "0",
          num: "6",
          desc: "まだ勉強しておらず、JavaScriptとの並行して勉強していくのか、どうするのかで止まっています。優先順位的にもうスキルアップした後に勉強開始予定です。"
        },
        {
          icon: "../icon-wp.svg",
          title: "WordPress",
          level: "7",
          num: "7",
          desc: "テンプレート階層を理解して、オリジナルテーマを作成でき、サーバー移転、function.phpの記述ができます。1回だけTCDのテーマから制作がありましたが、オリジナルテーマのほうがやりやすいです。機能少なめなECサイトの制作は業務で経験しました。プラグインは作り方は知っていますが、使用したことはありません。"
        },
        {
          icon: "../icon-vue.svg",
          title: "Vue.js",
